...
class Transpose(TensorOp):
    ...
    def compute(self, a):
        ### BEGIN YOUR SOLUTION
      # axs = array_api.arange(len(a.shape))
      ...
      # axs[a2] = a1
      # axs[a1] = a2       
      # return array_api.transpose(a, axes=axs)
      axes = self.axes
      if axes is None:
          axes = (-2, -1)
...
class Summation(TensorOp):
    ...
    def gradient(self, out_grad, node):
        ### BEGIN YOUR SOLUTION
        return array_api.broadcast_to(out_grad, node.inputs[0].shape)
        ### END YOUR SOLUTION
...
class MatMul(TensorOp):
    ...
    def gradient(self, out_grad, node):
        ...
        a,b = node.inputs
        # a = a.Trans
        # b = array_api.swapaxes(a.data, -2,-1)
